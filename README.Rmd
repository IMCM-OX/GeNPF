...
The main goal of {GeNPF} is to achieve a painless pull and push of data between workspaces and Rstudio interactive environment, saving time for analysis and data exploration.
